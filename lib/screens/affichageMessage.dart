...
class AffichagePage extends StatefulWidget {
  const AffichagePage({super.key});

  @override
  State<AffichagePage> createState() => _AffichageScreenStage();
}

class _AffichageScreenStage extends State<AffichagePage> {
